...
plugins {
    ...
    id("pl.allegro.tech.build.axion-release") version "1.14.4" // https://plugins.gradle.org/plugin/pl.allegro.tech.build.axion-release
}
...
subprojects {
    ...
    extra.apply {
        ...
        set("classGraphVersion", "4.8.155")     // https://mvnrepository.com/artifact/io.github.classgraph/classgraph
